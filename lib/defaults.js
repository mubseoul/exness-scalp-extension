...
export const DEFAULTS = {
  ...
  // Signal generation
  signal: {
    instrument: 'GC=F',       // Yahoo symbol — gold futures front-month (XAUUSD spot proxy)
    fallbackInstrument: 'XAUUSD=X',
    interval: '1m',           // 1m bars
  ...
  // Exness page interaction — populated by Calibration mode in popup
  exness: {
