...
export const DEFAULTS = {
  ...
  signal: {
    ...
    breakoutAtrMult: 0.15,    // require breakout move >= 0.15 * ATR (loose for testing)
    minAtrUsd: 0.25,          // skip if ATR(14) < $0.25
  ...
  claude: {
    ...
    minConfidence: 50,        // skip if Claude's confidence < this
